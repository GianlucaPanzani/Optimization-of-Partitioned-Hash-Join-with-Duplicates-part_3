...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        \texttt{omp\_loop} & 32 & 32 & 0.571 & \(5.89\times\) \\
...
\begin{table}[H]
    ...
    \begin{tabular}{llrrrrr}
        ...
        \midrule
        \texttt{skewed\_90\_5} & \texttt{omp\_loop} & 32 & 32 & 1.323 & 0.966 & \(2.12\times\) \\
        \texttt{skewed\_90\_5} & \texttt{omp\_loop\_wb} & 32 & 32 & 0.769 & 0.413 & \(3.65\times\) \\
        \texttt{skewed\_90\_5} & \texttt{omp\_task} & 64 & 32 & 0.636 & 0.286 & \(4.41\times\) \\
        \texttt{skewed\_90\_5} & \texttt{omp\_task\_wb} & 64 & 32 & 0.710 & 0.362 & \(3.95\times\) \\
        \texttt{skewed\_90\_5} & \texttt{omp\_taskloop} & 64 & 32 & 0.871 & 0.527 & \(3.22\times\) \\
        \texttt{skewed\_90\_5} & \texttt{omp\_taskloop\_wb} & 64 & 32 & 0.839 & 0.497 & \(3.34\times\) \\
        \midrule
        \texttt{skewed\_90\_1} & \texttt{omp\_loop} & 32 & 32 & 2.573 & 2.236 & \(1.22\times\) \\
        \texttt{skewed\_90\_1} & \texttt{omp\_loop\_wb} & 32 & 32 & 1.670 & 1.334 & \(1.87\times\) \\
        \texttt{skewed\_90\_1} & \texttt{omp\_task} & 64 & 32 & 1.856 & 1.521 & \(1.69\times\) \\
        \texttt{skewed\_90\_1} & \texttt{omp\_task\_wb} & 64 & 32 & 1.501 & 1.170 & \(2.08\times\) \\
        \texttt{skewed\_90\_1} & \texttt{omp\_taskloop} & 64 & 32 & 2.561 & 2.234 & \(1.22\times\) \\
        \texttt{skewed\_90\_1} & \texttt{omp\_taskloop\_wb} & 64 & 32 & 2.912 & 2.586 & \(1.07\times\) \\
        \bottomrule
    \end{tabular}
